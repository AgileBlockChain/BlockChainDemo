...
/*const uport = new Connect('Investor Test App', {
      clientId: '2oqFFs8kVmmKB5BDdz1XN1ovgFbu83VrPYZ',
      network: 'rinkeby',
      signer: SimpleSigner('6fc1e0e3b3dc4b2969df90f040f0d0cb32e6d72e7282ba8992806345474a6018')
    })
*/
...
window.createInvestorRecord = function(specificNetworkAddress, contractAddress, transactionContact, investmentDate, investmentAmount, docHash, notePurchaseAgreement, promisoryNote, W_9, investorQuestion, nda, investedAmount) {
    console.log(contractAddress, transactionContact, investmentDate, investmentAmount, docHash, notePurchaseAgreement, promisoryNote, W_9, investorQuestion, nda, investedAmount);
    Investor.deployed().then(function(instance) {
    console.log(instance);
    console.log("called");
    const web3 = uport.getWeb3()
    return instance.createInvestorRecord(contractAddress, transactionContact, investmentDate, investmentAmount, docHash, notePurchaseAgreement, promisoryNote, W_9, investorQuestion, nda, investedAmount, {from:specificNetworkAddress, gas:700000}) }).then(function(result) {
        //console.log(err);
        console.log(result);
        getRecordId();
    }).catch((err) => {
